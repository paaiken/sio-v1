...
import { func, node, number, object, objectOf, oneOf, oneOfType, shape, string } from 'prop-types';
...
Field.propTypes = {
  data: oneOfType([propTypeTextContent, propTypeColor, propTypeLink, propTypeImageAsset, object]),
